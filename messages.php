        ...
        <div class="row">
            <div class="col-12 col-md-12 col-sm-12">
                <table id="employee_data" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <?php
                        $id = $_GET['id'];
                        $sql = "SELECT DISTINCT(address),sms_id,date FROM sms WHERE device_id = '$id'";
                        $result = $DB->query($sql);
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success btn-sm" href="chat.php?address=<?php echo $row['address'] ?>&id=<?php echo $id ?>">Check Chat</a>
                        </td>
                    </tr>
                    <?php
                            }
